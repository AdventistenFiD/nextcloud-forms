OC.L10N.register(
    ...
    "Use this question as confirmation email recipient" : "Diese Frage als Empfängeradresse für die Bestätigungs-E-Mail verwenden",
    "Require respondents to verify this email address" : "Teilnehmer müssen diese E-Mail-Adresse bestätigen",
    ...
    "One email address per line (for example: team@example.com)" : "Eine E-Mail-Adresse pro Zeile (zum Beispiel: team@example.com)",
    ...
    "Confirmation for your response to %s" : "Bestätigung deiner Antwort auf %s",
    "Form Submission Confirmed" : "Formularübermittlung bestätigt",
    "Thank you for submitting the form %s. We have successfully received your response." : "Vielen Dank für das Ausfüllen des Formulars %s. Wir haben deine Antwort erfolgreich erhalten.",
    "Your responses:" : "Deine Antworten:",
    "This message was sent automatically by %s." : "Diese Nachricht wurde automatisch von %s gesendet.",
    "Verify your email for %s" : "Bestätige deine E-Mail-Adresse für %s",
    "Verify your email address" : "Bestätige deine E-Mail-Adresse",
    "A response was submitted to %s using this email address." : "Für %s wurde mit dieser E-Mail-Adresse eine Antwort eingereicht.",
    "Please verify your email address to confirm ownership of this submission." : "Bitte bestätige deine E-Mail-Adresse, um zu bestätigen, dass diese Einsendung von dir stammt.",
    "Verify email address" : "E-Mail-Adresse bestätigen",
    "Email address verified" : "E-Mail-Adresse bestätigt",
    "Email verification failed" : "Bestätigung der E-Mail-Adresse fehlgeschlagen",
    "Your email address has been verified successfully. You can close this page now." : "Deine E-Mail-Adresse wurde erfolgreich bestätigt. Du kannst diese Seite jetzt schließen.",
    "The verification link is invalid or expired." : "Der Bestätigungslink ist ungültig oder abgelaufen.",
